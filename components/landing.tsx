                ...
                <div className="flex flex-col-reverse sm:flex-row items-center justify-center">
                    <div className="flex flex-col max-w-[50rem] space-y-3 sm:space-y-6">
                        ...
                        >
                            <Link
                                href="/work"
                                className="group tracking-wide bg-pink-400 text-white font-bold text-2xl sm:text-[40px] sm:leading-[50px] px-6 py-4 flex items-center gap-2 rounded-2xl outline-none hover:scale-110 hover:bg-pink-900 transition"
                                prefetch={true}
                            >
                                Check out my work
                            </Link>
