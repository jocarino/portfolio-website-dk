...
export default function Architecture() {
  ...
  return (
    <section ref={ref} id="architecture" className="scroll-mt-10 sm:scroll-mt-28 mb-28 w-full space-y-9">
      <div id="hand-drawn" className="scroll-mt-10 w-full flex flex-col items-center">
        <SectionHeading className="bg-waitingForYou" classNameColorOverlay="bg-[#0000006B]">Hand Drawn</SectionHeading>
        <Wrapper>
      ...
      <div id="cad" className="scroll-mt-10 w-full flex flex-col items-center">
      ...
      <div id="urban-cultures" className="scroll-mt-10 w-full flex flex-col items-center">
      ...
      <div id="architecture-and-city" className="scroll-mt-10 w-full flex flex-col items-center">
      ...
      <div id="advanced-design" className="scroll-mt-10 w-full flex flex-col items-center">
        <SectionHeading className="bg-advancedDesign" classNameColorOverlay="bg-[#0000006B]">Advanced Architectural Design</SectionHeading>
        <Wrapper>
